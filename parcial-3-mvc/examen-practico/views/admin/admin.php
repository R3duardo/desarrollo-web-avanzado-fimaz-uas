...
<div class="mx-auto p-5">
  <div class="card text-center">
    ...
    <div class="card-body">
              ...
              <div class="card text-center">
                  ...
                  <div class="card-body">
                      ...
                      <a href="frmtorneos.php" class="btn btn-primary">
                          <img src="../img/torneo-admin.jpg" alt="Crear un torneo." width="180"
                          height="180">
                      </a>
              ...
              <div class="card text-center">
                  ...
                  <div class="card-body">
                    ...
                    <a href="readAllTorneos.php" class="btn btn-primary">
                      <img src="../img/lista-torneos-admin.jpg" alt="Lista de torneos." width="180"
                          height="180">
                    </a>
      ...
      <!--ANADIREMOS OTRA FILA CON DOS CARDS -->
      <div class="row">
          <div class="col">
              <div class="card text-center">
                  <div class="card-header">
